...
import loadingAnimation from './Constants/animation/loading_starter.json'; // 올바른 경로
    ...
    <>
      ...
      {isLoading ? (
        <div className="loading-container">
          <Lottie options={defaultOptions} height={180} width={240} />
          <div className="loading-text">
            질문을 요약하는 중입니다. <br />잠시만 기다려 주세요
          </div>
        </div>
      ) : (
        <>
            ...
            <div className="footer-container">
              <div className="newsletter">
                ...
                <div className="social-icons">
                  ...
                  <a href="https://www.instagram.com/startingblock_official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noreferrer noopener">
